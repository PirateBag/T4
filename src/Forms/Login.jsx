    ...
    return (
        <div>
            <form onSubmit={formService.handleSubmit} >
                ...
                <br/>
                    <PlaceHolderInput type={"text"} name={"userName"} placeholder={"user"} setMessage={setMessage}  whenRequired={REQUIRED_ADD} />
                <br/>
                    <PlaceHolderInput type={"text"} name={"password"} placeholder={"password"}  setMessage={setMessage} whenRequired={REQUIRED_ADD} />
                <br/>
